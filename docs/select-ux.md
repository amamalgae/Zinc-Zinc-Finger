...
- Candidate generation is not truncated to an arbitrary top-30 set. Every designable candidate across the complete submitted target DNA is retained and ranked.
...
- Candidate rows retain compact functional decision cues (method/B-score, target-DNA coordinate and spacer).
